...
/**
 * The fastest way to implement maps in your application is by using GUI. Click File, New, Google, Google Maps Activity and that's it.
 */
    ...
    private void setUpMap() {
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                Toast.makeText(getApplicationContext(), "Map is long clicked", Toast.LENGTH_SHORT).show();
            }
        });
